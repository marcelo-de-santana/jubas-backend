...
public class EmployeeController {
        ...
        @Operation(summary = "Buscar todos os funcionários cadastrados.", description = "Se 'available' for verdadeiro, retorna apenas aqueles que possuem permissão de BARBEIRO", responses = {
        ...
        public ResponseEntity<List<ScheduleTimeResponse>> findAppointmentsByEmployee(
        ...
        @GetMapping("/{employeeId}/available-specialties")
        public ResponseEntity<List<SpecialtyResponse>> getAvailableSpecialties(
                @PathVariable UUID employeeId,
                @RequestParam @Schema(type = "string") @JsonFormat(pattern = "yyyy-MM-dd HH:mm") LocalDateTime dateTime){

                return ResponseEntity.ok(service.getAvailableSpecialties(employeeId, dateTime));
        }
        ...
        @Operation(summary = "Atualizar funcionário.", responses = {
