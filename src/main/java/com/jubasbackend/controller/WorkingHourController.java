...
public class WorkingHourController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Jornada de trabalho já cadastrada."),
            @ApiResponse(responseCode = "500", description = "Erro ao cadastrar jornada de trabalho.")
    })
    @PostMapping
    public ResponseEntity<Void> createWorkingHour(@NonNull @RequestBody WorkingHourRequest request) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Jornada de trabalho atualizada com sucesso."),
            @ApiResponse(responseCode = "404", description = "Registro não encontrado."),
            @ApiResponse(responseCode = "500", description = "Erro ao atualizar jornada de trabalho.")
    })
    @PutMapping("/{workingHourId}")
    public ResponseEntity<Void> updateWorkingHour(@PathVariable UUID workingHourId,
                                                  @RequestBody WorkingHourRequest request) {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = "Erro ao excluir jornada de trabalho.")
    })
